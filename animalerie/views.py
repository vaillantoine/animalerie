...
def animal_detail(request, id_animal):
    ...
    if form.is_valid():
        ...
        nouveau_lieux_ancien_etat = {'mangeoire': 'affamé',
                                    ...
                                    'nid': 'fatigué',
                                    'litière': 'endormi'}
        if (ancien_etat == nouveau_lieux_ancien_etat[nouveau_lieu.id_equip]) and (nouveau_lieu.disponibilite or (nouveau_lieu.id_equip == 'litière')):
        ...
        form = MoveForm()
        nouveau_lieu = animal.lieu

    return render(request,
                  'animalerie/animal_detail.html',
                  {'animal': animal, 'lieu': nouveau_lieu, 'form': form})
